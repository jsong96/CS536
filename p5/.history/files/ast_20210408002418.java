...
class OrNode extends BinaryExpNode {
    ...
    public Type typeCheck() {
        ...
        IdNode lhs_id = myExp1.getIdNode();
        IdNode rhs_id = myExp2.getIdNode();

        if (lhs instanceof ErrorType) {
            hasErr = true;
        } else {
            if (!(lhs instanceof BoolType)) {
                lhs_id.notifyError("Logical operator applied to non-bool operand");
                hasErr = true;
            }
        }
        ...
        if (rhs instanceof ErrorType) {
            ...
            if (!(rhs instanceof BoolType)) {
                rhs_id.notifyError("Logical operator applied to non-bool operand");
                hasErr = true;
            }
        }
