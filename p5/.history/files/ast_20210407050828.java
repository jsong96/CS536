...
class AssignNode extends ExpNode {
    ...
    public Type typeCheck() {
        ...
        if (myLhs.typeCheck().toString().equals("int") || myLhs.typeCheck().toString().equals("bool")) {

        } else {

        }

        if (myExp.typeCheck().toString().equals("int") || myExp.typeCheck().toString().equals("bool")) {
