...
class CallExpNode extends ExpNode {
    ...
    public Type typeCheck() {
        ...
        if (!(fnType instanceof FnType)) {
            ...
            List<ExpNode> formalList = myExpList.getExpList();
            System.out.println(fs.getNumParams() + " : " + formalList.size());
            if (formalList.size() != fs.getNumParams()) {
                myId.notifyError("Function call with wrong number of args");
                return new ErrorType();
            }
            List<Type> declFormals = fs.getParamTypes();
