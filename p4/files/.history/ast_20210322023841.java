...
class DeclListNode extends ASTnode {
    ...
    public void nameAnalysis(SymTable table) {
        HashMap<String, Integer> declCount = new HashMap<>();
        for (DeclNode dNode : myDecls) {
            IdNode id = dNode.getIdNode();
            String name = id.getStringval();
            System.out.println(name);
            if (declCount.get(id.getStringval()) == null) {
                declCount.put(id.getStringval(), 1);
            } else {
