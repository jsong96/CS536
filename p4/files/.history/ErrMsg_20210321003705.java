...
class ErrMsg {
    ...
    static void multiDeclareErr(int lineNum, int charNum, String msg) {
        System.err.println(lineNum + ":" + charNum + " Multiply declared identifer");
    }

    static void undeclareErr(int lineNum, int charNum, String msg) {
        System.err.println(lineNum + ":" + charNum + " Undeclared identifier");
    }

    static void badStructAccessErr(int lineNum, int charNum, String msg) {
        System.err.println();
    }
}
